        ...
        <>
            ...
            >
                <div className="transform  h-[28rem] w-[20rem] transition -mx-3 duration-500 rounded-xl hover:-translate-y-[19rem] ">
                    <div className="">
                        <div>
                            <img src={event.image} className="h-[18rem] w-[17rem] mx-auto rounded-xl mb-6" />
                        </div>
                        ...
                        {event.performer == 'Lohar The Blacksmiths' ? <h2 className=" -mt-2 flex justify-center flex-wrap proshow-performer text-xl p-5 font-bold event-performer">
                            {event.performer}
                        </h2> :
                        ...
                        <div className='flex justify-between text-base proshow-performer'>
                            <div className='proshow-performer'><MdMyLocation className='inline -translate-y-[2px]' /> {event.location}</div>
                            <div className='mr-[10px] proshow-performer '> <CgSandClock className='inline -translate-y-[2px] -ml-[20px]' /> {event.time}</div>
                        </div>
